...
const ProductsCard = ({ product}) => {
  ...
  return (
    <div className="group w-full max-w-sm overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      {/* Product Image */}
      <div onClick={()=> navigate(`/detail/${product.id}`)} className="relative flex h-72 items-center justify-center bg-gray-50 p-6">
        <img
          src={product.image}
          alt={product.title}
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button  className="rounded-xl bg-black px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-gray-800 active:scale-95">
            Add to Cart
          </button>
